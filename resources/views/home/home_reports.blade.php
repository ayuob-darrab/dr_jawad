...
<form action="reports_search" method="get">
...
<table class="table table-bordered data-table" style="text-align: center;" dir="rtl">
    <thead>
        <tr>
            ...
            <th width="150px">مسح المعلومات </th>
            <th width="200px"> تعديل المعلومات  </th>
        </tr>
    </thead>
    <tbody>
        @php
        ...
        <tr>
            ...
            <td>
                <a href="admin/{{ $patient->id }}&delete_patient/edit">
                    <button id="modal-btn" class="btn btn-danger btn-rounded waves-effect waves-light"
                        style="width: 125px;"> مسح </button></a>



{{--
                        <a href="admin/{{ $patient->id }}&delete_patient/edit">
                            <button class="btn btn-info danger-rounded waves-effect waves-light" style="width: 75px;">تعديل</button></a> --}}
            </td>
            <td>
                <button type="button" class="myBtn btn btn-warning  btn-rounded waves-effect waves-light"
                    data-toggle="modal" data-modal-target="{{ $patient->id }}">

                     تعديل المعلومات الشخصية <i class="fe-file-edit"></i></button>
...
<div class="modal" id="myModal{{ $patient->id }}">
    ...
    <div class="modal-content">
        <div class="modal-header" dir="rtl">
            ...
            <h2 class="modal-title">   تعديل المعلوملت الشخصية للمريض : {{ $patient->name }} </h2>
        </div>
        <div class="modal-body">
            ...
            {{ Form::hidden('update_informatioons', 'update_informatioons') }}
            ...
            <div class="mb-3">
                ...
                <input style="text-align: center;"  id="patient_name" type="text" class="form-control"
                    name="patient_name" placeholder="{{ __('Patient Name') }}" value="{{ $patient->name }}" required>
                @error('patient_name')
            ...
            <div class="mb-3">
                ...
                <input style="text-align: center;" id="patient_phone" type="text" class="form-control"
                    name="patient_phone" placeholder="{{ __('Phone Number') }}" value="{{ $patient->id }}" required>
                @error('patient_phone')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3 text-end" style="text-align: center;">
                <button type="submit" class="btn btn-primary">{{ __('  تعديل المعلومات الشخصية ') }}</button>
            </div>
